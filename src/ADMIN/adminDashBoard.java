...
/**
    ...
    private void initComponents() {
        ...
        users_page = new javax.swing.JLabel();
        ...
        users_page1.setText("REPORT PAGE");
        users_page1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                users_page1MouseClicked(evt);
            }
        });
        reportpanel.add(users_page1);
        users_page1.setBounds(0, 10, 170, 20);
        ...
        users_page.setBackground(new java.awt.Color(44, 71, 35));
        users_page.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        users_page.setForeground(new java.awt.Color(255, 255, 255));
        users_page.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        users_page.setText("USER PAGE");
        users_page.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                users_pageMouseClicked(evt);
            }
        });
        userpanel.add(users_page, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 170, 20));

        navbar.add(userpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 170, 50));
    ...
    private javax.swing.JLabel users_page;
